...
```bash
cd ~/ros2_ws/src
git clone <이 저장소 주소> cobot2-project
```
...
```bash
pip install langchain langchain-openai pyserial
```
...
- `requirements.txt`에는 `langchain`, `langchain-openai`, `pyserial` 추가 여부를 확인해야 합니다.
